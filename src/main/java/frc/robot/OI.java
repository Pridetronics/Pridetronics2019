...
public class OI {
  ...
  public JoystickButton joystickButton3; // CargoBall
  ...
  public JoystickButton joystickButton7; // Rocket Ball 3
  public JoystickButton button8; // Rocket Hatch 3
  public JoystickButton joystickButton9; // Rocket Ball 2
  ...
  public JoystickButton gamepadButton8; // toggle between tank (default) and arcade

  public JoystickButton joystickButton13; // Lift up
  public JoystickButton joystickButton14; // Lift down
  ...
  public OI() {
    ...
    joystickButton13 = new JoystickButton(joystick, 1);
    joystickButton13.whileHeld(new RunLiftUp());
    joystickButton14 = new JoystickButton(joystick, 2);
    joystickButton14.whileHeld(new RunLiftDown());
